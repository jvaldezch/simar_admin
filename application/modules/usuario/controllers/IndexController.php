...
class Usuario_IndexController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->view->headScript()
                ->appendFile("/js/usuario/index/index.js?" . time());
    }
    ...
    public function satmoAction() {
        ...
        $this->view->headScript()
                ...
                ->appendFile("/js/usuario/index/satmo.js?" . time());
    }
    ...
    public function satcoralAction() {
        ...
        $this->view->headScript()
                ...
                ->appendFile("https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.4.1/locales/bootstrap-datepicker.es.min.js")
                ->appendFile("/js/common/contentxmenu/jquery.contextMenu.min.js")
                ->appendFile("/js/usuario/index/satcoral.js?" . time());
    }
    ...
    public function verProductoAction() {
        ...
        $this->view->headScript()
                ...
                ->appendFile("/js/usuario/index/ver-producto.js?" . time());
        $f = array(
    ...
    public function categoriasAction() {
        ...
        $this->view->headScript()
                ->appendFile("/js/common/loadingoverlay.min.js")
                ->appendFile("/js/usuario/index/categorias.js?" . time());
    }
    ...
    public function gruposAction() {
        ...
        $this->view->headScript()
                ->appendFile("/js/common/loadingoverlay.min.js")
                ->appendFile("/js/usuario/index/grupos.js?" . time());
    }
    ...
    public function productosAction() {
        ...
        $this->view->headScript()
                ->appendFile("/js/common/loadingoverlay.min.js")
                ->appendFile("/js/usuario/index/productos.js?" . time());
    }
    ...
    public function verCategoriaAction() {
        ...
        $this->view->headScript()
                ...
                ->appendFile("/js/usuario/index/ver-categoria.js?" . time());
        $f = array(
                "*" => array("StringTrim", "StripTags"),
                "id" => array("Digits"),
        );
    ...
    public function verGrupoAction() {
        ...
        $this->view->headScript()
                ...
                ->appendFile("/js/common/jquery.validate.min.js")
                ->appendFile("/js/common/confirm/jquery-confirm.min.js")
                ->appendFile("/js/usuario/index/ver-grupo.js?" . time());
        $f = array(
                "*" => array("StringTrim", "StripTags"),
                "id" => array("Digits"),
        );
    ...
    public function poligonalesAction() {
        ...
        $this->view->headScript()
                ->appendFile("/js/common/loadingoverlay.min.js")
                ->appendFile("/js/usuario/index/poligonales.js?" . time());
    }
    ...
    public function calendarioAction() {
        ...
        $this->view->headScript()
                ->appendFile("/js/common/loadingoverlay.min.js")
                ->appendFile("/js/usuario/index/calendario.js?" . time());   
    }
    ...
    public function verPoligonalAction() {
        ...
        $this->view->headScript()
                ->appendFile("/js/common/loadingoverlay.min.js")
                ->appendFile("/js/usuario/index/ver-poligonal.js?" . time());
        $f = array(
                "*" => array("StringTrim", "StripTags"),
                "id" => array("Digits"),
        );
    ...
    public function verProductoDeCategoriaAction() {
        ...
        $this->view->headScript()
                ...
                ->appendFile("/js/common/jquery.validate.min.js")
                ->appendFile("/js/common/confirm/jquery-confirm.min.js")
                ->appendFile("/js/usuario/index/ver-producto-de-categoria.js?" . time());
        $f = array(
                "*" => array("StringTrim", "StripTags"),
                "id" => array("Digits"),
        );
